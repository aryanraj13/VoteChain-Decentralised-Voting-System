...
export default class Home extends Component {
  ...
  try {
    ...
    console.log("Election artifact networks:", Election.networks);

    // Try normal lookup
    let deployedNetwork =
      Election.networks[networkId] ||
      Election.networks[String(networkId)];

    // Fallback address from your migration
    const FALLBACK_ADDRESS = "0x8dad547D6C067EdEfA265D4C7890232431a1cA95";

    let contractAddress;
    if (deployedNetwork && deployedNetwork.address) {
      console.log("Contract found in artifact:", deployedNetwork.address);
      contractAddress = deployedNetwork.address;
    } else {
      console.warn(
        "Artifact did NOT contain networks[" +
          networkId +
    ...
    // Create instance
    const instance = new web3.eth.Contract(Election.abi, contractAddress);
